...
var CodegenDirectory = function () {
  function CodegenDirectory(dir) {
    ...
    if (require('fs').existsSync(dir)) {
      !require('fs').statSync(dir).isDirectory() ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'Expected `%s` to be a directory.', dir) : require('fbjs/lib/invariant')(false) : void 0;
