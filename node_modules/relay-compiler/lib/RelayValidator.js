...
var GLOBAL_RULES = require('graphql-compiler').Validator.GLOBAL_RULES,
    LOCAL_RULES = require('graphql-compiler').Validator.LOCAL_RULES,
    validate = require('graphql-compiler').Validator.validate;
