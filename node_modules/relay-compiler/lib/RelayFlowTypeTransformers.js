...
function transformNonNullableInputType(type, state) {
  if (type instanceof require('graphql').GraphQLList) {
    ...
    var props = Object.keys(fields).map(function (key) {
      ...
      if (!(field.type instanceof require('graphql').GraphQLNonNull)) {
