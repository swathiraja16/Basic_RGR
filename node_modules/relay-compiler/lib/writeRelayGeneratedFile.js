...
let writeRelayGeneratedFile = (() => {
  var _ref = (0, _asyncToGenerator3.default)(function* (codegenDir, generatedNode, formatModule, typeText, _persistQuery, platform, relayRuntimeModule, sourceHash, extension) {
    ...
    var typeName = generatedNode.kind === require('relay-runtime').RelayConcreteNode.FRAGMENT ? 'ConcreteFragment' : generatedNode.kind === require('relay-runtime').RelayConcreteNode.REQUEST ? 'ConcreteRequest' : generatedNode.kind === require('relay-runtime').RelayConcreteNode.BATCH_REQUEST ? 'ConcreteBatchRequest' : null;
