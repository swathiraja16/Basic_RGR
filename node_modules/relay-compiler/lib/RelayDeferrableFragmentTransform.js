...
function transform(context) {
  ...
  context.forEachDocument(function (document) {
    ...
    require('graphql-compiler').IRVisitor.visit(document, {
      LinkedField: {
        enter: function enter(field) {
          var pathPart = field.alias || field.name;
          var fieldType = field.type;
          while (fieldType.ofType) {
            if (fieldType instanceof require('graphql').GraphQLList) {
              pathPart += '[*]';
            }
  ...
  var transformedContext = require('graphql-compiler').IRTransformer.transform(context, {
...
function createDeferrableReference(context, spreadUsesWithin, spread) {
  ...
  !require('graphql').doTypesOverlap(schema, fragmentType, nodeType) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayDeferrableFragmentsTransform: Cannot defer %s since objects of ' + 'type %s can never also be of type Node.', spread.name, fragmentType) : require('fbjs/lib/invariant')(false) : void 0;
  !(spread.args.length === 0) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayDeferrableFragmentsTransform: Cannot defer %s with arguments.', spread.name) : require('fbjs/lib/invariant')(false) : void 0;
...
function createDeferrableOperation(context, fragment) {
  ...
  !queryType ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayDeferrableFragmentTransform: "Query" must be a defined type') : require('fbjs/lib/invariant')(false) : void 0;
  var nodeField = queryType.getFields().node;
  !nodeField ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayDeferrableFragmentTransform: "Query" must define the field "node"') : require('fbjs/lib/invariant')(false) : void 0;
  var idArg = nodeField.args.find(function (arg) {
    return arg.name === 'id';
  });
  !(idArg && require('graphql').isInputType(idArg.type)) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayDeferrableFragmentTransform: "node" field must define the argument "id"') : require('fbjs/lib/invariant')(false) : void 0;
...
function getNodeType(schema) {
  ...
  !(nodeType instanceof require('graphql').GraphQLInterfaceType) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayDeferrableFragmentTransform: Schema must define the interface "Node".') : require('fbjs/lib/invariant')(false) : void 0;
  return nodeType;
}
...
function getIdType(schema) {
  ...
  !idField ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayDeferrableFragmentTransform: "Node" must define the field "id"') : require('fbjs/lib/invariant')(false) : void 0;
  var idType = require('graphql').getNamedType(idField.type);
  !require('graphql').isInputType(idType) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayDeferrableFragmentTransform: "Node" must define the scalar field "id"') : require('fbjs/lib/invariant')(false) : void 0;
  return idType;
}
