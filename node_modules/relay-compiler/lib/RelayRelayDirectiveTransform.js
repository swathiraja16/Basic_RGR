...
function visitRelayMetadata(metadataFn) {
  return function (node) {
    ...
    var argValues = require('graphql-compiler').getLiteralArgumentValues(relayDirective.args);
...
function fragmentSpreadMetadata(_ref3) {
  ...
  !(mask === undefined || typeof mask === 'boolean') ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayRelayDirectiveTransform: Expected the "mask" argument to @relay ' + 'to be a boolean literal if specified.') : require('fbjs/lib/invariant')(false) : void 0;
  !(deferrable === undefined || typeof deferrable === 'boolean') ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayRelayDirectiveTransform: Expected the "deferrable" argument to ' + '@relay to be a boolean literal if specified.') : require('fbjs/lib/invariant')(false) : void 0;
  !!(deferrable === true && mask === false) ? process.env.NODE_ENV !== 'production' ? require('fbjs/lib/invariant')(false, 'RelayRelayDirectiveTransform: Cannot unmask a deferrable fragment spread.') : require('fbjs/lib/invariant')(false) : void 0;
